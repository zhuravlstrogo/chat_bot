greet = "Привет, {name}, я бот, использующий нейросети. Мы можем поболтать ☺️"
menu = "📍 Главное меню"
...
gen_wait="нейросети нужно пару минут ⌛ \n📌сейчас ответ приводится частично, но система постоянно развивается и совершенствуется "
